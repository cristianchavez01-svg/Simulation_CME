...
Ahora bien, la estructura del Sol (desde su interior) comprende el \textit{núcleo} (en inglés \textit{core}), en donde se dan las condiciones de temperatura ($\gtrsim 10^{7}$K) y presión ($\gtrsim 10^{15}$ nitrógeno$/m^{2}$) suficientes para fusionar Hidrógeno en Helio, liberando una gran cantidad de energía la cual pasa a la \textit{zona radiativa} ($\approx 10^{7}$K, $10^{13}-10^{15}$nitrógeno$/m^{2}$) que transporta dicha energía en forma de radiación (fotones) hacia la \textit{zona convectiva} ($10^{4}-10^{6}$K, $10^{4}-10^{13}$nitrógeno$/m^{2}$), que es en donde se almacena esta energía, es decir que se calienta el plasma que limita con la zona convectiva, debido a un apantallamiento por parte de átomos los cuales se forman en la región superior de la zona convectiva, gracias a su relativa baja temperatura, generando un gradiente de temperatura que produce la convección del calor hacia la superficie produciendo células de convección (granulación). Ya en la superficie solar se encuentra la \textit{fotósfera} ($10^{3}-10^{4}$K, $10^{1}-10^{4}$nitrógeno$/m^{2}$), donde la densidad del plasma disminuye tanto que los fotones pueden escapar libremente al espacio enfriando el plasma que viene de la zona convectiva. Luego está la \textit{cromosfera} ($\approx10^{4}$K, $10^{1}-10^{-2}$nitrógeno$/m^{2}$), una capa de plasma rojizo y dinámico, seguido por la \textit{corona solar} ($\approx 10^{6}$K, $\approx 10^{-2}$nitrógeno$/m^{2}$), que es la atmósfera exterior extremadamente tenue pero increíblemente caliente, todo esto según \textcite[13--20]{judge-2020}. Estas dos últimas capas son el origen del viento solar y del comportamiento del clima espacial.
