...
Hoy sabemos que el Sol está hecho de \index{plasma}.
...
Esta rotación diferencial es la que alimenta el ciclo solar generando estructuras como Manchas solares, \acp{CME}\index{Coronal Mass Ejection}, Llamaradas solares entre otros, es decir que alimenta el Dinamo solar.
