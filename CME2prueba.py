...
# PARÁMETROS FÍSICOS
tr1, td1 = 120, 1300    # tiempos de subida y caída (s)
ar1, ad1 = 0.002, 5.250  # amplitudes de aceleración (km/s²) y desaceleración (km/s²)
v01, x01 = 100, 20000 # km/s y km
DENSIDAD_FONDO = 100 # Densidad de fondo en protones/cm³
R_CME_INICIAL = 1.5  # Radio inicial de la CME en radios solares (R☉)
...
fig.suptitle('Cinemática de la CME - 2', fontsize=20)
