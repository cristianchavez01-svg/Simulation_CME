...
fig.suptitle('Cinemática de la CME - 2', fontsize=20, y=0.98)
...
plt.savefig("cinematica_original_CME2.pdf", dpi=300, bbox_inches='tight')
print("✓ Gráfica cinemática guardada: cinematica_original_CME2.pdf")
plt.show()
...
# ──────────────────────────────────────────────────────────────────────────────
print("\n" + "="*80)
print("VISUALIZACIÓN POLAR: CME-2")
print("="*80)
...
fig.suptitle('Propagación de CME - 2', fontsize=18, fontweight='normal', y=0.99)
fig.text(0.5, 0.935, f'{T_HORAS} horas de propagación',
         ha='center', fontsize=13, style='italic', color='#444444')
...
plt.savefig("cme_evolucion_polar_CME2.pdf", dpi=300, bbox_inches='tight')
print("\n✓ Visualización guardada: cme_evolucion_polar_CME2.pdf")
plt.show()

print("\n" + "="*80)
print("✓ SIMULACIÓN CME-2 COMPLETADA")
print("="*80)
