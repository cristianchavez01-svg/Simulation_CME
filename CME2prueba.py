...
def velocidad(t):
    return v02 if t == 0 else v02 + quad(f, 0, t)[0]
...
def desplazamiento_centro(t):
    ...
    return x02 + np.trapz(velocidades_int, tiempos_int)
...
fig.suptitle('Propagación de CME - 2',
...
for idx, t_frame in enumerate(tiempos_frames):
    ...
    # Primeros 4 frames: zoom proporcional al r_cme (crece progresivamente)
    # Últimos 4 frames: ylim fijo al máximo global
    if idx < 4:
        limite_frame = r_cme * 2.7
